...
6. **Direitos do titular (art. 18) e canal de atendimento** — confirmação de tratamento, acesso, correção, eliminação, informação sobre compartilhamento. Fluxo: o titular aciona a prefeitura (controladora), que aciona a operadora pelo canal `[E-MAIL DE CONTATO — fornecido pelo orquestrador na dispatch desta task; se não fornecido, PARAR e perguntar em vez de inventar]`. Prazo de resposta da operadora à controladora: 15 dias.
